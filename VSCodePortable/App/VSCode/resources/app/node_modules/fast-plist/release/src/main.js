...
function parse(content) {
    ...
    function skipWhitespace() {
        while (i < len) {
            var chCode = content.charCodeAt(i);
    ...
    function advanceUntil(str) {
        var nextOccurence = content.indexOf(str, i);
        if (nextOccurence !== -1) {
    ...
    function captureUntil(str) {
        var nextOccurence = content.indexOf(str, i);
        if (nextOccurence !== -1) {
            var r = content.substring(i, nextOccurence);
            i = nextOccurence + str.length;
            return r;
        }
        else {
            // EOF
            var r = content.substr(i);
            i = len;
            return r;
        }
    }
    ...
    while (i < len) {
        ...
        var peekChCode = content.charCodeAt(i);
        if (peekChCode === 63 /*?*/) {
            i++;
            advanceUntil('?>');
            continue;
